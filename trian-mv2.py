...
from cnn_model.mobile_net_v2 import MobileNetV2
...
def main(args):
    ...
    if args.weights != "":
        ...
        print(model.load_state_dict(pre_dict, strict=False))
    ...
    for epoch in range(args.epochs):
        ...
        if epoch >= args.epochs * 0.95:
            torch.save(model.state_dict(), "./weights-train/{}_weights/model--{}-{}.pth".format(args.exp_name,args.exp_name,epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='mv2-aug-tomato-8-2-300epochs')
    ...
    parser.add_argument('--weights', type=str, default='/home/xjw/Documents/mobilenet_v2-b0353104.pth',
